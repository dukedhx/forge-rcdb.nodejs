        ...
        }
        {
          ...
          <div>
            <span className="fa fa-refresh"
              ...
              data-tip
            />
            <ReactTooltip id={`reload-${props.id}`}
      ...
      <div className="treenode click-trigger">
        ...
        <div>
          <span className="fa fa-cloud-upload"
            ...
            data-tip
          />
          <ReactTooltip id={`upload-${props.id}`}
            className="tooltip-text"
            effect="solid">
            <div>
        ...
        <div>
          <span className="fa fa fa-plus"
            ...
            data-tip
          />
          <ReactTooltip id={`create-folder-${props.id}`}
            className="tooltip-text"
            effect="solid">
            <div>
                {`Create folder ...`}
        ...
        <div>
          <span className="fa fa fa-search"
            ...
            data-tip
          />
          <ReactTooltip id={`search-${props.id}`}
            className="tooltip-text"
            effect="solid">
            <div>
                {`Search that folder ...`}
      ...
      <div className="treenode click-trigger">
        ...
        }
        {
          ...
          <div>
            ...
            <ReactTooltip id={`versions-${props.id}`}
              className="tooltip-text"
              effect="solid">
              <div>
                Versions control
        ...
        }
        {
          ...
          <div>
            <span className="fa fa-file-image-o"
              ...
              data-tip
            />
            <ReactTooltip id={`thumbnail-${props.id}`}
        ...
        }
        {
          ...
          <div>
            <span className="fa fa-times"
              ...
              data-tip
            />
            <ReactTooltip id={`delete-${props.id}`}
              className="tooltip-text"
              effect="solid">
              <div>
                {`Delete item ...`}
        ...
        }
        {
          props.control &&
          <div>
            <span className={props.control.className}
              data-for={`control-${props.id}`}
              onClick={props.control.onClick}
              data-tip
            />
            <ReactTooltip id={`control-${props.id}`}
              className="tooltip-text"
              effect="solid">
              <div>
